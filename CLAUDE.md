...
| **F4** | Consulta — Motor Q v2 completo + panel apilable (**6.009 líneas** medidas, no 4.901) | F2 | **Plan v2 listo** (`Planes/plan_F4_consulta_2026-08-20.md`), auditado contra el origen y contra los pipelines. DA-1/2/3 cerradas. Sin empezar a codificar |
